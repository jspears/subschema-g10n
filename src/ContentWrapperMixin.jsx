...
var {IntlMixin,    FormattedMessage}    ='react-intl';
...
var ContentWrapper = React.createClass({
    mixins: [require('../ValueManagerListenerMixin'), IntlMixin],
    substitute(str) {
        var checks = {};
    ...
    render(){
        ...
        return <Type {...props}>
            <FormattedMessage key='content' message={this.props.content} {...this.state}/>
            {children}
        </Type>
